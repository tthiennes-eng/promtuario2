...
class _$AttachmentImpl implements _Attachment {
  ...
  @override
  String toString() {
    return 'Attachment(id: $id, patientId: $patientId, name: $name, type: $type, url: $url, date: $date, uploadedBy: $uploadedBy, description: $description)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, patientId, name, type, url,
      date, uploadedBy, description);
