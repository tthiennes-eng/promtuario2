...
class $ClinicsLocalTable extends ClinicsLocal
  ...
  static const VerificationMeta _slotDurationMinutesMeta =
      const VerificationMeta('slotDurationMinutes');
  @override
  late final GeneratedColumn<int> slotDurationMinutes = GeneratedColumn<int>(
      'slot_duration_minutes', aliasedName, false,
      type: DriftSqlType.int,
      requiredDuringInsert: false,
  ...
  VerificationContext validateIntegrity(Insertable<ClinicsLocalData> instance,
    ...
    if (data.containsKey('slot_duration_minutes')) {
      context.handle(
          _slotDurationMinutesMeta,
          slotDurationMinutes.isAcceptableOrUnknown(
              data['slot_duration_minutes']!, _slotDurationMinutesMeta));
    }
  ...
  ClinicsLocalData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ClinicsLocalData(
      ...
      slotDurationMinutes: attachedDatabase.typeMapping.read(
          DriftSqlType.int, data['${effectivePrefix}slot_duration_minutes'])!,
...
class ClinicsLocalData extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['slot_duration_minutes'] = Variable<int>(slotDurationMinutes);
  ...
  factory ClinicsLocalData.fromJson(Map<String, dynamic> json,
    ...
    return ClinicsLocalData(
      ...
      slotDurationMinutes:
          serializer.fromJson<int>(json['slotDurationMinutes']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'slotDurationMinutes': serializer.toJson<int>(slotDurationMinutes),
  ...
  ClinicsLocalData copyWithCompanion(ClinicsLocalCompanion data) {
    return ClinicsLocalData(
      ...
      slotDurationMinutes: data.slotDurationMinutes.present
          ? data.slotDurationMinutes.value
  ...
  String toString() {
    return (StringBuffer('ClinicsLocalData(')
          ...
          ..write('slotDurationMinutes: $slotDurationMinutes, ')
  ...
  @override
  int get hashCode => Object.hash(id, name, description, location, capacity,
      isActive, startHour, endHour, slotDurationMinutes, metadataJson);
  @override
  bool operator ==(Object other) =>
      ...
      (other is ClinicsLocalData &&
          ...
          other.slotDurationMinutes == this.slotDurationMinutes &&
...
class ClinicsLocalCompanion extends UpdateCompanion<ClinicsLocalData> {
  ...
  final Value<int> slotDurationMinutes;
  ...
  const ClinicsLocalCompanion({
    ...
    this.slotDurationMinutes = const Value.absent(),
  ...
  static Insertable<ClinicsLocalData> custom({
    ...
    Expression<int>? slotDurationMinutes,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (slotDurationMinutes.present) {
      map['slot_duration_minutes'] = Variable<int>(slotDurationMinutes.value);
    }
...
class $$ClinicsLocalTableFilterComposer
  ...
  ColumnFilters<int> get slotDurationMinutes => $composableBuilder(
      column: $table.slotDurationMinutes,
...
class $$ClinicsLocalTableOrderingComposer
  ...
  ColumnOrderings<int> get slotDurationMinutes => $composableBuilder(
      column: $table.slotDurationMinutes,
...
class $$ClinicsLocalTableAnnotationComposer
  ...
  GeneratedColumn<int> get slotDurationMinutes => $composableBuilder(
      column: $table.slotDurationMinutes, builder: (column) => column);
  ...
  $$ClinicsLocalTableTableManager(_$AppDatabase db, $ClinicsLocalTable table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<int> slotDurationMinutes = const Value.absent(),
            Value<String?> metadataJson = const Value.absent(),
